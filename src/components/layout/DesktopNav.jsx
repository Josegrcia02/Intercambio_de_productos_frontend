...
import { Search, PlusCircle, MessageSquare, User, Package, ShieldAlert, BarChart3 } from "lucide-react";
...
export function DesktopNav() {
  ...
  if (user?.is_staff) {
      ...
      navItems.push({ path: "/admin/estadisticas", icon: BarChart3, label: "Estadísticas" });
  }
