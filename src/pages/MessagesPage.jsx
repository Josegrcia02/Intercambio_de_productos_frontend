  ...
  return (
    <div className="h-[calc(100vh-64px)] flex bg-white overflow-hidden">
            ...
            <div className="p-4 bg-white border-b flex items-center justify-between shadow-sm z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p 
                    className="text-xs text-blue-500 font-medium hover:underline cursor-pointer transition-all"
                    onClick={() => navigate(`/product/${selectedChat.producto_id}`)}
                    title="Ir a los detalles del producto"
                  >
                    {selectedChat.producto_titulo}
                  </p>
                </div>
              </div>
              {/* BOTÓN DE BORRAR */}
      ...
      <ConfirmModal 
        ...
        title="Borrar Conversación"
        message={`¿Estás seguro de que quieres borrar el chat con ${selectedChat?.otro_usuario?.username}? Se borrará para ambos.`}
      />
    </div>
  );
};
